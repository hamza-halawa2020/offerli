...
<head>
    ...
    <title>Offerli Reset Password</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold ms-1">Offerli</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Reset Password</h4>
                        {{-- <p class="mb-4">for <span class="fw-medium">john.doe@email.com</span></p> --}}
                        <form action="{{ route('password.store') }}" method="post" id="formAuthentication">
                            @csrf
