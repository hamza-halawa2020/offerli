...
@section('title')
    <title data-i18n="New Event">New Event</title>
@endsection
...
@section('content')
    @if (auth()->user()->hasPermissionTo('Add Voucher'))
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4" data-i18n="New Event">Create Event</h4>
            @if ($errors->any())
            ...
            <div id="wizard-create-deal" class="bs-stepper vertical mt-2">
                <div class="bs-stepper-header">
                    <div class="step" data-target="#deal-type">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                <span class="bs-stepper-title" data-i18n="Event Type">Event Type</span>
                                <span class="bs-stepper-subtitle" data-i18n="Choose type of Event">Choose type of Event</span>
                            </span>
                        </button>
                    </div>
                    <div class="line"></div>
                    <div class="step" data-target="#deal-details">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                <span class="bs-stepper-title" data-i18n="Event Details">Event Details</span>
                                <span class="bs-stepper-subtitle" data-i18n="Provide Event details">Provide Event
                                    details</span>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="step" data-target="#deal-usage">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                <span class="bs-stepper-title" data-i18n="Event Usage">Event Usage</span>
                ...
                <div class="bs-stepper-content">
                    <form action="{{ route('voucher.storeEvent') }}" method="POST" id="wizard-create-deal-form">
                        @csrf
                        <!-- Deal Type -->
                        <div id="deal-type" class="content">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="price" class="form-text" data-i18n="Enter the price (if it is free enter 0 )">
                                        Enter the price (if it is free enter 0 )</div>
                                </div>
                                ...
                                {{-- <div class="col-sm-6">
                                    ...
                                    <div id="subcategory" class="form-text" data-i18n="select SubCategory">Select
                                        Category.</div>
                                </div> --}}
                        ...
                        <div id="deal-details" class="content">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <label class="form-label" for="dealTitle" data-i18n="Event Title">Event Title</label>
                                    <input type="text" id="dealTitle" name="dealTitle" class="form-control"
                                        placeholder="Black friday sale, 25% off" />
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label" for="code" data-i18n="Deal Code">Event Code</label>
                                    <input type="text" id="code" name="code" class="form-control" disabled
                                        placeholder="25PEROFF" />
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label" for="dealDescription" data-i18n="Deal Description">Event
                                        Description</label>
                                ...
                                <div class="col-sm-6">
                                    <label for="dealDuration" class="form-label" data-i18n="Date">
                                        Date</label>
