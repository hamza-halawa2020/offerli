...
@section('title')
    <title data-i18n="Edit Voucher">Edit Voucher</title>
@endsection
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-select" aria-label="Sub-Category" name="subcategory">
                                        ...
                                        @foreach ($subCategories as $subCategory)
                                            @if ($subCategory->id == $voucher->subcategory_id)
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="dealTitle" name="dealTitle" class="form-control"
                                        placeholder="Black friday sale, 25% off" value="{{ $voucher->title }}" />
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label" for="dealCode" data-i18n="Deal Code">Deal Code</label>
                                    <input type="text" id="dealCode" name="dealCode" class="form-control" disabled
                                        placeholder="25PEROFF" value="{{ $voucher->code }}" />
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <textarea id="dealDescription" name="dealDescription" class="form-control" rows="5"
                                        placeholder="To sell or distribute something as a business deal">{{ $voucher->description }}</textarea>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="dealDuration" name="dealDuration" class="form-control"
                                        placeholder="YYYY-MM-DD " value="{{ $voucher->expire_at }}" />
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" id="dealMaxUsers" name="dealMaxUsers" class="form-control"
                                        placeholder="500" value={{ $voucher->limit }} />
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="dealPaymentMethod" name="dealPaymentMethod" class="form-select">
                                        ...
                                        @foreach ($paymenttypes as $paymenttype)
                                            @if ($paymenttype->id == $voucher->payment_id)
                                                <option value="{{ $paymenttype->id }}" selected>{{ $paymenttype->name }}
                                                </option>
                                            @else
                                ...
                                <div class="col-lg-12">
                                    <label class="switch">
                                        <input type="checkbox" class="switch-input" id="dealLimitUser"
                                            name="dealLimitUser" {{ $voucher->singleUse ? 'checked' : '' }} />
                                        ...
                                        <span class="switch-label"
                                            ...
                                            discount
                                            to a single-use per customer?</span>
                                    </label>
                                </div>
                                <div class="col-12 d-flex justify-content-between mt-4">
                                    <button class="btn btn-label-secondary btn-prev">
                                    ...
                                    <button type="submit" class="btn btn-success btn-submit">
                                        <span class="align-middle d-sm-inline-block d-none me-sm-1"
                                            data-i18n="Update">Update</span><i class="ti ti-check ti-xs"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
