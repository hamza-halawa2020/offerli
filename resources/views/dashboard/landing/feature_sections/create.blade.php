...
@section('title')
    <title data-i18n="New feature">New feature</title>
@endsection
            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4 mt-4">
                        <div class="card-feature d-flex justify-content-between align-items-center">
                            <h5 class="mb-0" data-i18n="New feature">New feature</h5>
                            <small class="text-muted float-end"></small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('feature-sections.store') }}" method="post"
