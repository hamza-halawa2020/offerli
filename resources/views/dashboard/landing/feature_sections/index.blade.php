    ...
    @if (auth()->user()->hasPermissionTo('Edit Landing'))
        <div class="container-xxl flex-grow-1 container-p-y">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h4 data-i18n="Landing section" style="margin: 0;"> feature section</h4>
                @if (auth()->user()->hasPermissionTo('Edit Landing'))
                    <a class="btn btn-primary " style="margin: 0;" href={{ route('feature-sections.create') }}
                        data-i18n="Add New feature">
                        Add New feature</a>
                @endif
            </div>
            <div class="row">
                    ...
                    <tbody>
                        @foreach ($features as $feature)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('images/featureSections/' . $feature->image) }}" alt=""
                                        width="150px" height="150px">
                                </td>
                                @if (auth()->user()->hasPermissionTo('Edit Landing'))
                                    <td>
                                        <form
                                            action="{{ route('feature-sections.destroy', ['feature_section' => $feature->id]) }}"
