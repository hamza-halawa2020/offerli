...
try {
    ...
    function changeLayout(e) {
        ...
        console.log("Change layout function called");

        const switcherRtl = document.getElementById("switchRtl");
        if (!switcherRtl) {
            console.error("Element with ID 'switchRtl' not found");
            return;
        }

        const currentLanguage = switcherRtl.dataset.language;
        console.log("Current language:", currentLanguage);

        // Toggle between languages
        const selectedLanguage = currentLanguage === "en" ? "ar" : "en";
        console.log("Selected language:", selectedLanguage);
        switcherRtl.dataset.language = selectedLanguage;
        // Determine the URL based on the selected language
        const url = window.location.origin + "/offerli/" + selectedLanguage;
